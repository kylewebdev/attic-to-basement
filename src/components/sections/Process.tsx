...
const steps = [
    ...
    },
    {
        ...
        description:
            "We run the entire sale: managing foot traffic, answering questions, handling transactions, and keeping everything organized and secure. We have it covered.",
    ...
    },
    {
        ...
        description:
            "After the sale, we handle remaining items through, cleanout, or coordinated donation to a nonprofit of your choice. The home is left clean and ready for its next chapter.",
        icon: "M5 13l4 4L19 7",
    },
];
...
export default function Process() {
    ...
    useEffect(() => {
        ...
        const update = () => {
            ...
            const startY =
                offsetRelativeTo(firstIcon, parent) +
                firstIcon.offsetHeight / 2;
            const endY =
                offsetRelativeTo(lastIcon, parent) + lastIcon.offsetHeight / 2;
        ...
        () => {
            ...
            registerSection(start, duration, (tl, s, d) => {
                ...
                stepEls.forEach((step, i) => {
                    ...
                    if (i > 0) {
                        const prevText =
                            stepEls[i - 1].querySelector("[data-step-text]");
                        if (prevText) {
                            tl.to(
                                prevText,
