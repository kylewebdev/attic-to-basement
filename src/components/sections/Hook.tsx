...
export default function Hook() {
    ...
    useGSAP(
        () => {
            ...
            registerSection(start, duration, (tl, s, d) => {
                ...
                const scrollArrow =
                    sectionRef.current.querySelector("[data-hook-arrow]");
    ...
    return (
        ...
        >
            {/* Background image */}
            <div data-hook-bg className="absolute inset-0" aria-hidden="true">
                <Image
                    src="/IMG_6490.webp"
                    alt=""
                    fill
            ...
            <div className="sticky top-0 min-h-screen flex items-center justify-center relative z-10">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    >
                        ...
                        through a home full of belongings can feel impossible.
