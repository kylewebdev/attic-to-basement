      ...
      <section className="py-16 md:py-24 bg-warm-white">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            >
              <span className="text-stone-500 text-sm">Photo of Cortnee</span>
            </div>
            ...
            <div data-reveal data-reveal-delay="200">
              ...
              <div className="space-y-4 text-stone-400 leading-relaxed">
                <p>
                  ...
                  parts of a major life transition &mdash; figuring out what to
                  do with a lifetime of belongings.
                </p>
                <p>
                  With over two decades of combined experience across Northern
                  California, she has built a team that treats every home like it
                  matters &mdash; because it does. From the first walkthrough to
                  the final sweep, her approach is simple: handle everything with
                  honesty, care, and the kind of thoroughness that lets families
