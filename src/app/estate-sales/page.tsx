          ...
          {sales.length > 0 ? (
            ...
            <div data-reveal className="text-center py-12">
              ...
              <p className="text-stone-500 mb-6">
                Follow us on Instagram for the latest updates and sale
                announcements.
              </p>
              <a
                href="https://www.instagram.com/abeliquidators/"
                target="_blank"
              ...
              >
                ...
                Follow @abeliquidators on Instagram
              </a>
            </div>
          )}
        </div>
      ...
      <section className="py-16 md:py-24 bg-sage-50">
        <div className="max-w-3xl mx-auto px-4 text-center" data-reveal>
          ...
          <p className="mt-4 text-lg text-stone-400 max-w-xl mx-auto">
            We handle everything from start to finish — organizing, staging,
            pricing, marketing, and cleanup. Let us take it from here.
          </p>
          <div className="mt-8">
